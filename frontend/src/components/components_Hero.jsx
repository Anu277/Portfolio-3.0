        ...
        <div className="flex flex-col md:flex-row items-center z-10">
          ...
          <div className="w-full md:w-1/2 ">
            ...
            <div className="flex flex-wrap space-x-6">
              ...
              <a href="https://drive.google.com/file/d/13S8yae8PV9Inbvk5WjkZQJAyF6l-XHUg/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-gray-900 flex flex-row items-center p-2 rounded-md bg-rose-500">
                <FaFileAlt size={30} />
